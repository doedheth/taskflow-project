/**
 * Incoming Material Inspection Type Definitions - Frontend
 */
...
export interface Inspection {
  ...
  vehicle_closed: number; // Deprecated or kept for backward compatibility?
  ...
  measure_unit: string | null; // Added: 'KG', 'PCS', 'LITER', etc.
...
export interface InspectionItem {
  ...
  scale_weight?: number | null; // Added: sampling scale weight input
  is_ok: number;
  notes: string | null;
}
...
export interface InspectionWithDetails extends Inspection {
  ...
  checker_name?: string;
  batch_numbers?: string; // Added: Aggregated batch numbers for list view
  total_arrival_qty?: number;
